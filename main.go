...
func init() {
	...
	utilruntime.Must(dependencyv1.AddToScheme(scheme))
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:   "5c5359d2.kepler.operator.com",
	})
	if err != nil {
	...
	if err = (&controllers.KeplerDependencyReconciler{
		Client: mgr.GetClient(),
		Log:    ctrl.Log.WithName("controllers").WithName("KeplerDependency"),
