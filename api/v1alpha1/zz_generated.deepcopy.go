...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ModelServerTrainer) DeepCopyInto(out *ModelServerTrainer) {
	*out = *in
	...
	if in.InitialModelNames != nil {
		in, out := &in.InitialModelNames, &out.InitialModelNames
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ModelServerTrainer.
func (in *ModelServerTrainer) DeepCopy() *ModelServerTrainer {
	if in == nil {
		return nil
	}
	out := new(ModelServerTrainer)
