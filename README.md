...
kubectl wait --for=condition=ready --timeout=180s pod -n monitoring -l "release=prometheus"
...
- [Validate Prometheus Integration](docs/user/guides/validating-prometheus-integration.md) - Verify metrics are being collected
- [Setup Grafana Dashboards](docs/user/guides/grafana-dashboard.md) - Visualize power consumption metrics
- [Configuration Options](docs/user/guides/configuration.md) - Customize Kepler deployment
...
- **Usage**:
  ...
  - [Configuration Options](docs/user/guides/configuration.md)
