module github.com/sustainable.computing.io/kepler-operator/tests/e2e
...
replace (
	github.com/go-jose/go-jose/v4 => github.com/go-jose/go-jose/v4 v4.0.5 // to address CVEs in cert-manager v1.16.4
	github.com/golang/glog => github.com/golang/glog v1.2.4
	github.com/hashicorp/vault => github.com/hashicorp/vault v1.20.0 // to address CVEs in cert-manager v1.16.4
	github.com/sustainable.computing.io/kepler-operator => ../..
