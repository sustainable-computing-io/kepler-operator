...
func TestPowerMonitorNodeSelector(t *testing.T) {
	...
	pm := f.CreatePowerMonitor("power-monitor", f.WithPowerMonitorNodeSelector(labels))
...
func TestPowerMonitorNodeSelectorUnavailableLabel(t *testing.T) {
	...
	pm := f.CreatePowerMonitor("power-monitor", f.WithPowerMonitorNodeSelector(unavailableLabels))
...
func TestPowerMonitorTaint_WithToleration(t *testing.T) {
	...
	pm := f.CreatePowerMonitor("power-monitor", f.WithPowerMonitorTolerations(append(node.Spec.Taints, e2eTestTaint)))
	f.AssertResourceExists(controller.PowerMonitorDeploymentNS, "", &corev1.Namespace{})
	ds := appsv1.DaemonSet{}
	f.AssertResourceExists(pm.Name, controller.PowerMonitorDeploymentNS, &ds)
...
func TestBadPowerMonitorTaint_WithToleration(t *testing.T) {
	...
	pm := f.CreatePowerMonitor("power-monitor", f.WithPowerMonitorTolerations(append(node.Spec.Taints, badTestTaint)))
