...
and allows a Source for provider-specific attributes<br/>
        </td>
        <td>false</td>
      </tr></tbody>
</table>
...
<table>
    ...
    <tbody><tr>
      ...
      <td>true</td>
        ...
        <td><b><a href="#keplerxspec">spec</a></b></td>
        <td>object</td>
        <td>
          KeplerXSpec defines the desired state of KeplerX<br/>
        </td>
        <td>false</td>
      </tr><tr>
        <td><b><a href="#keplerxstatus">status</a></b></td>
        <td>object</td>
        <td>
          <br/>
        </td>
...
### KeplerX.spec
<sup><sup>[↩ Parent](#keplerx)</sup></sup>
...
<table>
    ...
    <tbody><tr>
        <td><b><a href="#keplerxspecdeployment">deployment</a></b></td>
        <td>object</td>
        <td>
          <br/>
        </td>
        ...
        <td><b><a href="#keplerxspecconfiguration">configuration</a></b></td>
        <td>object</td>
        <td>
          <br/>
        </td>
        ...
        <td><b><a href="#keplerxspecopenshift">openshift</a></b></td>
        <td>object</td>
        <td>
          <br/>
        </td>
...
### KeplerX.spec.deployment
<sup><sup>[↩ Parent](#keplerxspec)</sup></sup>
...
<table>
    ...
    <tbody><tr>
        ...
        <td><b><a href="#keplerxspecdeploymenttolerationsindex">tolerations</a></b></td>
        <td>[]object</td>
        <td>
          If specified, define Pod's tolerations<br/>
          <br/>
...
### KeplerX.spec.deployment.tolerations[index]
<sup><sup>[↩ Parent](#keplerxspecdeployment)</sup></sup>
...
<table>
    ...
    <tbody><tr>
        ...
        <td><b>maxTrackedTerminatedProcesses</b></td>
        <td>integer</td>
        <td>
          <br/>
          <br/>
        ...
        <td><b>processRetentionPeriod</b></td>
        <td>integer</td>
        <td>
          <br/>
          <br/>
...
<table>
    ...
    <tbody><tr>
        ...
        <td><b><a href="#keplerxspecopenshiftdashboard">dashboard</a></b></td>
        <td>object</td>
        <td>
          <br/>
        </td>
...
### KeplerX.spec.openshift.dashboard
<sup><sup>[↩ Parent](#keplerxspecopenshift)</sup></sup>
...
<table>
    ...
    <tbody><tr>
        <td><b><a href="#keplerxstatusconditionsindex">conditions</a></b></td>
        <td>[]object</td>
        <td>
          conditions represent the latest available observations of kepler-x<br/>
        </td>
        <td>true</td>
      </tr><tr>
        <td><b>currentNumberScheduled</b></td>
...
supposed to run the kepler-x pod.<br/>
          <br/>
            <i>Format</i>: int32<br/>
        </td>
        <td>true</td>
...
pod (including nodes correctly running the kepler-x pod).<br/>
          <br/>
            <i>Format</i>: int32<br/>
        </td>
        <td>true</td>
...
and have one or more of the kepler-x pod running with a Ready Condition.<br/>
          <br/>
            <i>Format</i>: int32<br/>
        </td>
        <td>true</td>
...
more of the kepler-x pod running and available<br/>
          <br/>
            <i>Format</i>: int32<br/>
        </td>
        <td>false</td>
        ...
        <td>
          The number of nodes that should be running the
kepler-x pod and have none of the kepler-x pod running and available<br/>
          <br/>
            <i>Format</i>: int32<br/>
        </td>
        <td>false</td>
        ...
        <td>integer</td>
        <td>
          The total number of nodes that are running updated kepler-x pod<br/>
          <br/>
            <i>Format</i>: int32<br/>
        </td>
        <td>false</td>
...
### KeplerX.status.conditions[index]
<sup><sup>[↩ Parent](#keplerxstatus)</sup></sup>
