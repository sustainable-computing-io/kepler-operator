...
1. **kube-prometheus-stack installed** (recommended)
   - Includes Prometheus, prometheus-operator, and Grafana
   - See the [Kubernetes Installation Guide](../installation/kubernetes.md)
   - Alternative: Use [kube-prometheus-stack Helm chart](https://github.com/prometheus-community/helm-charts/tree/main/charts/kube-prometheus-stack)

   **OR**

   Manual installation:
   - **Prometheus with prometheus-operator** - See [Monitoring Stack Setup Guide](../installation/monitoring-stack-kubernetes.md)
   - **Grafana** with Prometheus datasource - Follow [Grafana installation docs](https://grafana.com/docs/grafana/latest/setup-grafana/installation/)
